...
('Dermatologist', 'Skin, hair, and nail specialist', 'fa-allergies'),
('Neurologist', 'Brain and nervous system specialist', 'fa-brain'),
('Pediatrician', 'Child and infant healthcare specialist', 'fa-baby'),
('Orthopedic', 'Bone and joint specialist', 'fa-bone'),
('General Physician', 'Primary care and general medicine', 'fa-stethoscope'),
('Dentist', 'Tooth and oral care specialist', 'fa-tooth'),
('Psychiatrist', 'Mental health specialist', 'fa-head-side-virus');
